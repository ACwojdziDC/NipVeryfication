...
using ApiVat.Blazor.Server.Services;
...
namespace ApiVat.Blazor.Server {
    public class Startup {
        ...
        public void ConfigureServices(IServiceCollection services) {
            ...
            services.AddXaf<ApiVatBlazorApplication>(Configuration);
            ...
            services.AddSwaggerGen(c => {
                ...
                c.SwaggerDoc("v1", new OpenApiInfo {
                    Title = "ApiVat API",
                    Version = "v1",
                    Description = @"Use AddXafWebApi(options) in the ApiVat.Blazor.Server\Startup.cs file to make Business Objects available in the Web API."
                });
        ...
        public void Configure(IApplicationBuilder app, IWebHostEnvironment env) {
            if(env.IsDevelopment()) {
                ...
                app.UseSwagger();
                app.UseSwaggerUI(c => {
                    c.SwaggerEndpoint("/swagger/v1/swagger.json", "ApiVat WebApi v1");
                });
            }
            else {
            ...
            app.UseEndpoints(endpoints => {
                ...
                endpoints.MapFallbackToPage("/GetNip");
