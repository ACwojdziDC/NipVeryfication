...
namespace ApiVat.Blazor.Server {
    public partial class ApiVatBlazorApplication : BlazorApplication {
        public ApiVatBlazorApplication() {
            InitializeComponent();
        }
        ...
        private void ApiVatBlazorApplication_DatabaseVersionMismatch(object sender, DatabaseVersionMismatchEventArgs e) {
#if EASYTEST
            e.Updater.Update();
            e.Handled = true;
#else
